          ...
          <div className="lg:col-span-2">
            <div>
              ...
              <a className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                ...
                <span>Acki Watch</span>
              </a>
              {/* </Link> */}
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
            Acki Watch is a powerful web service that offers on-chain transaction notifications and data upload capabilities on the Acki Nacki blockchain. Users can subscribe to their wallet addresses and receive real-time updates whenever transactions occur, making it valuable for traders and developers.
              <br></br>
              <br></br>
              <p>he service ensures privacy and security by not storing sensitive wallet information and encrypting data exchanges. Additionally, Acki Watch allows users to seamlessly upload data to Acki Nacki for permanent and decentralized storage, catering to various applications from content archiving to blockchain enthusiasts seeking to monitor their activities.
              </p>
            </div>
          </div>
