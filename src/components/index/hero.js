      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            Acki Watch is a powerful web service that enables users to subscribe with their wallet addresses and receive real-time notifications for on-chain transactions on the Acki Nacki blockchain. In addition to providing transaction monitoring, Acki Watch also facilitates the seamless upload of data to the Acki Nacki network.
            </p>
